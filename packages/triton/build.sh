...
&& gsutil cp ./pydemia--tritonserver-base:triton-${TRITON_VERSION}-py38.tar.gz gs://aiip-runtime-installer/install-offline/pydemia--tritonserver-base:triton-${TRITON_VERSION}-py38.tar.gz
