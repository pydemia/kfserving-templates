...
def request(_input, host=None, hostname=None, model_name=None, op='predict', version='v2'):
...
HOSTNAME = f'http://{MODEL_NAME}.{NAMESPACE}.example.com'
